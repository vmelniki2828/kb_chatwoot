...
.widget-wrapper {
  ...
  --slate-11: 107 107 107;
  --slate-12: 13 13 13;

  --background-color: 255 255 255;
  --text-blue: 13 13 13;
  --border-container: 236 236 236;
  --border-strong: 229 229 229;
  --border-weak: 236 236 236;
  --solid-1: 255 255 255;
  --solid-2: 255 255 255;
  --solid-3: 255 255 255;
  --solid-active: 255 255 255;
  --solid-amber: 252 232 193;
  --solid-blue: 16 163 127;
...
.dark .widget-wrapper {
  ...
  --slate-11: 172 172 172;
  --slate-12: 236 236 236;

  --background-color: 13 13 13;
  --border-strong: 45 45 45;
  --border-weak: 54 54 54;
  --solid-1: 23 23 26;
  --solid-2: 29 30 36;
  --solid-3: 44 45 54;
